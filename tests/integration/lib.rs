//! Seahorse Integration Test Helpers
//!
//! Common utilities for testing Seahorse-compiled programs with LiteSVM.
//! LiteSVM provides a fast, in-process Solana VM for integration testing
//! that simulates realistic transaction flows.
...
/// Create a LiteSVM instance with default configuration
pub fn create_litesvm() -> LiteSVM {
    LiteSVM::new()
}
